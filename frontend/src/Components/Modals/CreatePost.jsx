  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="sm:max-w-2xl bg-gray-800 rounded-2xl border-0 shadow-xl">
        <DialogHeader className={`rounded-t-xl bg-gradient-to-r ${getPostTypeColor()} p-4 -m-6 mb-2`}>
          <div className="flex items-center gap-2 mb-1">
            {getPostTypeIcon()}
            <DialogTitle className="text-xl font-bold">Share Your Knowledge</DialogTitle>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="custom-scrollbar">
              <div className="space-y-5">
                      ...
                      <div className="flex items-center justify-center w-full">
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="text-xs text-gray-400">PNG, JPG, GIF up to 10MB ({images.length}/3)</p>
                          </div>
                          <input
                            id="dropzone-file"
                            type="file"
                      ...
                      <div className="flex items-center justify-center w-full">
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="text-xs text-gray-400">MP4, WebM, max 30 seconds</p>
                          </div>
                          <input
                            id="video-upload"
                            type="file"
                ...
                {postType === "progress" && (
                  <div className="space-y-2">
                    <Label className="text-gray-300 font-medium">Progress Template</Label>
                ...
                {postType === "plan" && (
                  <div className="space-y-2">
                    <Label className="text-gray-300 font-medium">Estimated Completion Time</Label>
