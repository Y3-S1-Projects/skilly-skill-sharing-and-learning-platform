            ...
            <div className="space-y-2">
              ...
              >
                <TabsList className="grid w-full grid-cols-2 bg-gray-600 p-1 rounded-xl">
                  <TabsTrigger
                    value="skill"
                    className="rounded-lg flex items-center text-gray-300 gap-2 data-[state=active]:bg-gray-900 data-[state=active]:text-amber-700 data-[state=active]:shadow"
                  >
                  ...
                  <TabsTrigger
                    value="progress"
                    className="rounded-lg flex items-center gap-2 text-gray-300 data-[state=active]:bg-gray-900 data-[state=active]:text-blue-700 data-[state=active]:shadow"
                  >
                ...
                <div className="space-y-4">
                  ...
                  >
                    <TabsList className="grid w-full grid-cols-2 bg-gray-600 p-1 rounded-xl">
                      <TabsTrigger
                        value="images"
                        className="rounded-lg flex items-center text-gray-300 gap-2 data-[state=active]:bg-gray-900 data-[state=active]:text-indigo-700 data-[state=active]:shadow"
                      >
